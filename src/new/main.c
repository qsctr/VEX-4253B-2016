...
#pragma config(Motor,  port6,           mArm1,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           mArm2,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           mArm3,         tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           mArm4,         tmotorVex393_MC29, openLoop, reversed)
