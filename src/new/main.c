...
#pragma config(Sensor, in1,    potArm1,        sensorPotentiometer)
#pragma config(Sensor, in2,    potArm2,        sensorPotentiometer)
...
#pragma config(Motor,  port6,           mArmL1,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           mArmL2,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           mArmR1,        tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           mArmR2,        tmotorVex393_MC29, openLoop, reversed)
